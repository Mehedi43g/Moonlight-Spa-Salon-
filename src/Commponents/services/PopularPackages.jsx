            ...
            >
              ...
              <div className="flex flex-col flex-1 p-7">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className=" rounded-full  bg-[#FFF7E5]  px-4 py-2  text-xs font-semibold text-[#B68A00] " >
                    {item.duration}
                  </span>
                ...
                <div className="mt-auto pt-10 flex flex-col gap-4">
                  ...
                  <Link to="/book-now" className=" group/btn flex
                    items-center justify-center
                    gap-2  rounded-full  bg-[#1A1410] py-4  font-semibold
                    text-white  transition-all  duration-300  hover:bg-[#D4AF37]  hover:text-black  " >
                    Book Package
                  ...
                  <Link to={item.slug} className="  flex items-center
                    justify-center rounded-full  border-2  border-[#D4AF37] py-4 font-semibold
                    text-[#D4AF37] transition-all duration-300 hover:bg-[#D4AF37] hover:text-black " >
                    View Details
                  </Link>
