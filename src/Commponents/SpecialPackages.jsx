...
const SpecialPackages = () => {
  return (
    <section className="bg-[#f8f1e9] py-10">
      <Container>
        <div>
          <h3 className="text-[#0a0a09] text-center font-poppins text-[24px] md:text-[30px] font-bold">
            Special Packages
          </h3>

          <div className="flex flex-wrap justify-center gap-5 pt-5">

            <div className="w-full sm:w-[48%] md:w-[46%] lg:w-[31%] xl:w-[23%] pt-3">
              <div className="bg-white rounded-[10px] shadow-sm overflow-hidden h-full">
                <a href="#">
                  <img
                    className="rounded-t-[10px] w-full h-[180px] sm:h-[200px] lg:h-[170px] object-cover"
                    src={sp1}
                    alt="product image"
                  />
                </a>
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mt-4 gap-2">
                    <span className="text-[20px] font-extrabold text-heading">
                      ৳1299
                    </span>
